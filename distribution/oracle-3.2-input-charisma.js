...
const modifier = (text) => {
    ...
    class Player {
        constructor(player) {
            ...
            this.disableActions = {};
            this.charismaReputation = player.charismaReputation || {}; // Add this line
        }
    ...
    const defaultCharismaAction = {
        name: ["charisma", "speech", "diplomacy", "words", "speak", "converse", "influence", "flirt", "charm", "convene", "convince", "coax", "reason", "persuade", "persuasion", "encourage", "encouragement", "win over", "assure", "reassure", "reassurance", "comfort", "intimidate"],
